...
def same ():
    ...
    actr.add_text_to_exp_window(window, target, x=125, y=75)
    actr.add_text_to_exp_window(window, target, x=75, y=175)
    actr.add_text_to_exp_window(window, target, x=175, y=175)
...
def different ():
    ...
    actr.add_text_to_exp_window(window, items[0], x=125, y=75)
    actr.add_text_to_exp_window(window, items[1], x=75, y=175)
    actr.add_text_to_exp_window(window, items[2], x=175, y=175)
    ...
    if response.lower() == items[0].lower() or response.lower() == items[1].lower() or response.lower() == items[2].lower():
        return True
    else:
        return False
